...
const scopeItems = [
	{ title: 'Kosiarka bijakowa', desc: 'Koszenie wysokiej trawy, chwastów, zarośli i nieużytków' },
	{ title: 'Kosiarka pielęgnacyjna', desc: 'Regularne koszenie trawników i terenów zielonych' },
	{ title: 'Działki zaniedbane', desc: 'Porządkowanie zarośniętych działek i terenów inwestycyjnych' },
	{ title: 'Tereny rekreacyjne', desc: 'Boiska, place zabaw, tereny wokół posesji' },
];

const galleryImages = [
	{ src: '/img/zarosnieta-dzialka-przed-koszeniem-lublin.jpg', alt: 'Zarośnięta działka przed koszeniem — nieużytki Lublin', label: 'Przed' },
	{ src: '/img/koszenie-nieuzytkow-kosiarka-bijakowa-efekt.jpg', alt: 'Efekt koszenia kosiarką bijakową — uporządkowana działka Lublin', label: 'Po' },
];
				...
				<div className='grid grid-cols-1 md:grid-cols-5 md:grid-rows-[auto_1fr] gap-x-8 gap-y-4 md:gap-y-4 flex-1 mt-12 [&_p]:text-left'>
					...
					<div className='border-l-4 border-amber-500 pl-5'>
						...
						<p className='mt-2 text-sm leading-snug text-gray-600 max-w-lg'>
							Oferujemy profesjonalne koszenie działek i&nbsp;nieużytków przy użyciu dwóch
							typów kosiarek montowanych na minitraktorem. Kosiarka bijakowa radzi sobie
							z&nbsp;gęstą i&nbsp;zaniedbaną roślinnością — rozdrabnia gałęzie, twarde łodygi
							i&nbsp;samosiejki. Kosiarka pielęgnacyjna zapewnia równą i&nbsp;czystą linię cięcia
							na regularnie utrzymywanych trawnikach i&nbsp;terenach rekreacyjnych.
						</p>
					</div>
					</div>
					...
					>
						<h2 className='text-xs font-semibold text-gray-400 uppercase tracking-widest mb-2'>Zakres usług koszenia</h2>
						...
						<p className='mt-2 text-xs text-gray-400 leading-snug'>
							Usługi koszenia działek i&nbsp;nieużytków realizujemy na terenie <span className='text-gray-600 font-medium'>Lublina</span>,
