...
const attachments = [
	...
	{
		title: "PŁUG",
		image: "/img/minitraktor-plug-dwuskibowy-lublin.png",
					...
					>
						...
						>
							...
							<span className='text-xs text-gray-500 leading-snug'>
								...
								nieużytków i koszenia terenów zielonych. <b className="text-gray-900">Szczegóły dostępne są w
								opisach poszczególnych osprzętów.</b>
							</span>
						</div>
					</div>
						...
						<div className='grid grid-cols-2 xl:grid-cols-4 gap-3 grid-rows-[repeat(auto-fill,auto)]'>
							{attachments.map((attachment, i) => (
								<Link
									...
									className='group relative row-span-3 grid grid-rows-subgrid rounded-xl border border-gray-200 overflow-hidden bg-white opacity-0 animate-slideUp transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-amber-400/15 hover:border-amber-300'
									style={{
